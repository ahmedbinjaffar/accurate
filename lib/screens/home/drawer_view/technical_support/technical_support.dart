...
import 'package:accurate/models/Drawer_model/technical_support_model/technical_support_model.dart';
                  ...
                  children: [
                    ...
                    Expanded(
                      child: GridView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: technical_support_model.length,
                              ...
                              child: Column(
                                children: [
                                  CupertinoButton(
                                    onPressed: () async {
                                      final url =
                                          technical_support_model[index].linkii;
                                      if (await canLaunch(url)) {
                                        await launch(url);
                                      }
                                    },
                                    child: Image.asset(
                                      technical_support_model[index]
                                          .socialmediaicon,
                                      width: 100,
                                      height: 100,
                                    ),
                                  ...
                                  Text(
                                      technical_support_model[index].socialname)
                                ],
                              ));
                        },
                      ),
